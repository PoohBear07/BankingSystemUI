...
customerInfo;
  constructor(private httpClient: HttpClient) { }
   ...
   public getCustomerDetails(){
    return this.httpClient.get(`https://bankingsystemtsf.herokuapp.com/getCustomerDetails`);
  }
  public getTransactionDetails(customerInfo)
  {
  const headers = new HttpHeaders().append('header', 'value');
  const params = new HttpParams().append('sender', this.customerInfo.id);
  return this.httpClient.get(`https://bankingsystemtsf.herokuapp.com/getTransactionHistory`,{ headers: headers, params: params });
  }
  ...
  const headers = new HttpHeaders().append('header', 'value');
  const params = new HttpParams().append('sender', this.customerInfo.id);
  return this.httpClient.get(`https://bankingsystemtsf.herokuapp.com/getTransactionCustomerList`,{ headers: headers, params: params });
  }

  public saveTransaction(data)
  {
  const headers = new HttpHeaders().append('header', 'value');
  return this.httpClient.put<any>('https://bankingsystemtsf.herokuapp.com/updateTransaction', data);
  }
